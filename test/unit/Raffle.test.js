...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle", () => {
          ...
          describe("enterRaffle", () => {
              it("Revert you don't pay enough!", async () => {
          ...
          describe("checkUpkeep", () => {
              ...
              it("returns false if enough time hasn' passed", async () => {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
          ...
          describe("performUpkeep", () => {
              ...
              it("uptates the raffle state, emits and event, and calls the vrf coordinator", async () => {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
          ...
          describe("fulfilRandomWords", () => {
              ...
              it("picks a winner, reset the lottery, and send mony", async () => {
